...
fnameIn = fullfile(DAT_PATH, "HIIT10DT2_01.csv"); // Path of the info file <- You should change the name of the file with the name of your file in DAT folder
...
TimeWarmUp = Time(10);                           // get the duration in minutes of the warm-up in the info file
...
endEffort = Time(10) + Time(24);               // get the duration in minutes of the warm-up + effort in the info file
